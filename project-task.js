...
let completedTodos = todos.map(obj => {
return {
  ...obj,
  completed: true
};
...
console.log("All Tasks Completed:", completedTodos);
...
let sortedIncomplete = todos.filter(todo => todo.completed === false).sort(function(a, b) {
return a.priority - b.priority;
});
